...
Defined in: [packages/nova-core/src/hooks/useCopyToClipboard.ts:30](https://github.com/TuwaIO/nova-uikit/blob/dedb6275cfa76e55837201d18b3160c7a32b8a7e/packages/nova-core/src/hooks/useCopyToClipboard.ts#L30)

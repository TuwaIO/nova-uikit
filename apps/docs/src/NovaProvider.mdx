...
The **NovaProvider** is the centerpiece of the `@tuwaio/nova-transactions` library. It's a comprehensive, all-in-one solution that orchestrates the entire transaction tracking UI experience in your dApp. 🎯
    ...
    <WagmiProvider config={wagmiConfig}>
      <QueryClientProvider client={queryClient}>
        ...
        <NovaProvider
          ...
          // The adapters array, similar like using for store
...
| ------------------------ | ---------------------------------- | :------: | ------------------------------------------------------------------------ |
| `adapters`               | `TxAdapter[]`                      |    ✅    | The array of configured adapters similar to your Pulsar store.                 |
...
| `actions`                | `TxActions`                        |    -     | An object of actions for retry logic.                                    |

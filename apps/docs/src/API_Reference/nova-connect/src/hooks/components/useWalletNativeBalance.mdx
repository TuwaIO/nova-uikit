...
Defined in: [packages/nova-connect/src/hooks/useWalletNativeBalance.ts:65](https://github.com/TuwaIO/nova-uikit/blob/0ff78abbbf1cdf52866b6f590901b9dc77994547/packages/nova-connect/src/hooks/useWalletNativeBalance.ts#L65)

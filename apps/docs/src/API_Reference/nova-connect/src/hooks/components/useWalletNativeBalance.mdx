...
Defined in: [packages/nova-connect/src/hooks/useWalletNativeBalance.ts:65](https://github.com/TuwaIO/nova-uikit/blob/0e04009a8dc8e8e09a9f6dfd19cd3145e4e828c4/packages/nova-connect/src/hooks/useWalletNativeBalance.ts#L65)

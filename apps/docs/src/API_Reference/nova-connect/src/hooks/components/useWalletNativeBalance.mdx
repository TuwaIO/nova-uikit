...
Defined in: [packages/nova-connect/src/hooks/useWalletNativeBalance.ts:65](https://github.com/TuwaIO/nova-uikit/blob/34e33fc2d9a28ab9eb6980db775ee3740ce04383/packages/nova-connect/src/hooks/useWalletNativeBalance.ts#L65)

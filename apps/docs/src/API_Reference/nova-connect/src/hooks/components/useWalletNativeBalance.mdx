...
Defined in: [packages/nova-connect/src/hooks/useWalletNativeBalance.ts:65](https://github.com/TuwaIO/nova-uikit/blob/4da4f4c457e1d493e3fe63d3a5b97ee20aea2eef/packages/nova-connect/src/hooks/useWalletNativeBalance.ts#L65)

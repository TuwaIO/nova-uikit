...
Defined in: [packages/nova-connect/src/hooks/useWalletNativeBalance.ts:65](https://github.com/TuwaIO/nova-uikit/blob/de8bac39e15b4993550215cf3f0a1afe317b2eae/packages/nova-connect/src/hooks/useWalletNativeBalance.ts#L65)

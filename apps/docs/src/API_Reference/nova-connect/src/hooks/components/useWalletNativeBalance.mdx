...
Defined in: [packages/nova-connect/src/hooks/useWalletNativeBalance.ts:65](https://github.com/TuwaIO/nova-uikit/blob/03d1b99d0a23e3b8c201eed9bee0ec07c679297e/packages/nova-connect/src/hooks/useWalletNativeBalance.ts#L65)

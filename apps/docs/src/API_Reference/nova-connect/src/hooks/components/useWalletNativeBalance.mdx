...
Defined in: [packages/nova-connect/src/hooks/useWalletNativeBalance.ts:65](https://github.com/TuwaIO/nova-uikit/blob/c5966b47098fadfcd351ee0f3acccb5fb074cf44/packages/nova-connect/src/hooks/useWalletNativeBalance.ts#L65)

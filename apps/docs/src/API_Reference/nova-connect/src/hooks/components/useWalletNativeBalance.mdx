...
Defined in: [packages/nova-connect/src/hooks/useWalletNativeBalance.ts:65](https://github.com/TuwaIO/nova-uikit/blob/5c1f94b112c45e18313920ea0c67ba421cba2720/packages/nova-connect/src/hooks/useWalletNativeBalance.ts#L65)

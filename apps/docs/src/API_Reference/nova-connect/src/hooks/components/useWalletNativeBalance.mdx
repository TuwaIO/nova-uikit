...
Defined in: [packages/nova-connect/src/hooks/useWalletNativeBalance.ts:65](https://github.com/TuwaIO/nova-uikit/blob/3fe83b313b340e94fe267aac4ea7faa1db5af0df/packages/nova-connect/src/hooks/useWalletNativeBalance.ts#L65)
...
`Pick`\<`NovaConnectProviderProps`, `"store"`\> & `Pick`\<`NovaConnectProviderType`, `"activeWallet"`\>

...
Defined in: [packages/nova-connect/src/hooks/useWalletNativeBalance.ts:65](https://github.com/TuwaIO/nova-uikit/blob/e08f8f0af2816ec4f866c050f053f88532b89784/packages/nova-connect/src/hooks/useWalletNativeBalance.ts#L65)

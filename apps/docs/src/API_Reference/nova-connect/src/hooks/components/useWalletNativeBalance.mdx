...
Defined in: [packages/nova-connect/src/hooks/useWalletNativeBalance.ts:65](https://github.com/TuwaIO/nova-uikit/blob/549de94c179623155df073fefe76400fcd65bea1/packages/nova-connect/src/hooks/useWalletNativeBalance.ts#L65)

...
Defined in: [packages/nova-connect/src/hooks/useWalletNativeBalance.ts:65](https://github.com/TuwaIO/nova-uikit/blob/73fb7f5b76d81080c342f585bc261d3376288e10/packages/nova-connect/src/hooks/useWalletNativeBalance.ts#L65)

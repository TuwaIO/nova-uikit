...
Defined in: [packages/nova-connect/src/hooks/useGetWalletNameAndAvatar.ts:73](https://github.com/TuwaIO/nova-uikit/blob/f227d130007d40907dfb21ddf99a3a7d098f9afc/packages/nova-connect/src/hooks/useGetWalletNameAndAvatar.ts#L73)

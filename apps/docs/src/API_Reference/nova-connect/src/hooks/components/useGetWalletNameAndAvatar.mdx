...
Defined in: [packages/nova-connect/src/hooks/useGetWalletNameAndAvatar.ts:71](https://github.com/TuwaIO/nova-uikit/blob/061e66e258d305abb584390ba85ec4539a700037/packages/nova-connect/src/hooks/useGetWalletNameAndAvatar.ts#L71)

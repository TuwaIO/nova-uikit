...
Defined in: [packages/nova-connect/src/hooks/useGetWalletNameAndAvatar.ts:73](https://github.com/TuwaIO/nova-uikit/blob/3c61c838515a620036eb16b3b54fdb35a7c0f04b/packages/nova-connect/src/hooks/useGetWalletNameAndAvatar.ts#L73)

...
Defined in: [packages/nova-connect/src/hooks/useGetWalletNameAndAvatar.ts:71](https://github.com/TuwaIO/nova-uikit/blob/96dae07fda7b200f2f0bdb59111a304c9a56777c/packages/nova-connect/src/hooks/useGetWalletNameAndAvatar.ts#L71)

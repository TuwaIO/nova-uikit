...
Defined in: [packages/nova-connect/src/hooks/useGetWalletNameAndAvatar.ts:71](https://github.com/TuwaIO/nova-uikit/blob/2a3c4ab549f3e82043dd5b87241fd0e22f869649/packages/nova-connect/src/hooks/useGetWalletNameAndAvatar.ts#L71)

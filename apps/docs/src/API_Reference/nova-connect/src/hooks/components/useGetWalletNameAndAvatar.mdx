...
Defined in: [packages/nova-connect/src/hooks/useGetWalletNameAndAvatar.ts:71](https://github.com/TuwaIO/nova-uikit/blob/7f0ff6ef37314bbc0683c9566de3b0a1bfe718dc/packages/nova-connect/src/hooks/useGetWalletNameAndAvatar.ts#L71)

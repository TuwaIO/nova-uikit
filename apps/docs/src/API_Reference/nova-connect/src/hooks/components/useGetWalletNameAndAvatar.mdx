...
Defined in: [packages/nova-connect/src/hooks/useGetWalletNameAndAvatar.ts:71](https://github.com/TuwaIO/nova-uikit/blob/63d93779bde97fe7daf4313e46d7ca89e15beddc/packages/nova-connect/src/hooks/useGetWalletNameAndAvatar.ts#L71)

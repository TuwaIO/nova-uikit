...
Defined in: [packages/nova-connect/src/hooks/useGetWalletNameAndAvatar.ts:73](https://github.com/TuwaIO/nova-uikit/blob/1de20634cb4fa6020b9658ccb5e4f94cd501a495/packages/nova-connect/src/hooks/useGetWalletNameAndAvatar.ts#L73)

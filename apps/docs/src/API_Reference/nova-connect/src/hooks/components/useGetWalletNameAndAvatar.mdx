...
Defined in: [packages/nova-connect/src/hooks/useGetWalletNameAndAvatar.ts:73](https://github.com/TuwaIO/nova-uikit/blob/3fe83b313b340e94fe267aac4ea7faa1db5af0df/packages/nova-connect/src/hooks/useGetWalletNameAndAvatar.ts#L73)

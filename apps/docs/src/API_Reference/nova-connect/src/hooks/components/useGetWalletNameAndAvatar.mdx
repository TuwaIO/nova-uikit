...
Defined in: [packages/nova-connect/src/hooks/useGetWalletNameAndAvatar.ts:71](https://github.com/TuwaIO/nova-uikit/blob/ee1e0f015aaf08870185132c2f414ffdba29d3c3/packages/nova-connect/src/hooks/useGetWalletNameAndAvatar.ts#L71)

...
Defined in: [packages/nova-connect/src/hooks/useNovaConnectLabels.ts:52](https://github.com/TuwaIO/nova-uikit/blob/80b8faf3a35bd8332772e438fb69559c0e489541/packages/nova-connect/src/hooks/useNovaConnectLabels.ts#L52)

...
Defined in: [packages/nova-connect/src/hooks/useNovaConnectLabels.ts:52](https://github.com/TuwaIO/nova-uikit/blob/825ef39ce4069157f72aa8453c5d798ba28610f6/packages/nova-connect/src/hooks/useNovaConnectLabels.ts#L52)

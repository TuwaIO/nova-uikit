...
Defined in: [packages/nova-connect/src/hooks/useNovaConnectLabels.ts:52](https://github.com/TuwaIO/nova-uikit/blob/7a210c0ecc4043ba26cbaecdbd2d557ac81e9c59/packages/nova-connect/src/hooks/useNovaConnectLabels.ts#L52)

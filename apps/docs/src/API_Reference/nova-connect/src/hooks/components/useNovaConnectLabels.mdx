...
Defined in: [packages/nova-connect/src/hooks/useNovaConnectLabels.ts:52](https://github.com/TuwaIO/nova-uikit/blob/de8bac39e15b4993550215cf3f0a1afe317b2eae/packages/nova-connect/src/hooks/useNovaConnectLabels.ts#L52)

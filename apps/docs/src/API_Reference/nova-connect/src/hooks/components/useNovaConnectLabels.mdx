...
Defined in: [packages/nova-connect/src/hooks/useNovaConnectLabels.ts:52](https://github.com/TuwaIO/nova-uikit/blob/5f1e95d847f3167f7fdf0c6c0d7ff505cccf90d4/packages/nova-connect/src/hooks/useNovaConnectLabels.ts#L52)

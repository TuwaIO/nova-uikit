...
Defined in: [packages/nova-connect/src/hooks/useNovaConnectLabels.ts:52](https://github.com/TuwaIO/nova-uikit/blob/465727cc7679afe03481c0a87226bb585ac2e3b7/packages/nova-connect/src/hooks/useNovaConnectLabels.ts#L52)

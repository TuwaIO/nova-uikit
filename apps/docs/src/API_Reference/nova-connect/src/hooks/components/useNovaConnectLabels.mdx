...
Defined in: [packages/nova-connect/src/hooks/useNovaConnectLabels.ts:52](https://github.com/TuwaIO/nova-uikit/blob/eac112e7837b18e42b510f826448b83af4bada15/packages/nova-connect/src/hooks/useNovaConnectLabels.ts#L52)

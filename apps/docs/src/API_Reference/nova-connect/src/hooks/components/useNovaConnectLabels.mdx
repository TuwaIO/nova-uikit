...
Defined in: [packages/nova-connect/src/hooks/useNovaConnectLabels.ts:52](https://github.com/TuwaIO/nova-uikit/blob/4da4f4c457e1d493e3fe63d3a5b97ee20aea2eef/packages/nova-connect/src/hooks/useNovaConnectLabels.ts#L52)

...
Defined in: [packages/nova-connect/src/utils/adapters/types.ts:27](https://github.com/TuwaIO/nova-uikit/blob/61930600f9c702edb69aa836386e817394ab2bbd/packages/nova-connect/src/utils/adapters/types.ts#L27)
...
> `optional` **getAvailableClusters**(): `Promise`\<`string`[]\>

Defined in: [packages/nova-connect/src/utils/adapters/types.ts:99](https://github.com/TuwaIO/nova-uikit/blob/61930600f9c702edb69aa836386e817394ab2bbd/packages/nova-connect/src/utils/adapters/types.ts#L99)
...
> **getChains**(`config`, `chains?`): `Promise`\<(`string` \| `number`)[]\>

Defined in: [packages/nova-connect/src/utils/adapters/types.ts:57](https://github.com/TuwaIO/nova-uikit/blob/61930600f9c702edb69aa836386e817394ab2bbd/packages/nova-connect/src/utils/adapters/types.ts#L57)
...
Defined in: [packages/nova-connect/src/utils/adapters/types.ts:81](https://github.com/TuwaIO/nova-uikit/blob/61930600f9c702edb69aa836386e817394ab2bbd/packages/nova-connect/src/utils/adapters/types.ts#L81)
...
> `optional` **isValidCluster**(`cluster`): `Promise`\<`boolean`\>

Defined in: [packages/nova-connect/src/utils/adapters/types.ts:118](https://github.com/TuwaIO/nova-uikit/blob/61930600f9c702edb69aa836386e817394ab2bbd/packages/nova-connect/src/utils/adapters/types.ts#L118)

...
Defined in: [packages/nova-connect/src/utils/adapters/types.ts:155](https://github.com/TuwaIO/nova-uikit/blob/061e66e258d305abb584390ba85ec4539a700037/packages/nova-connect/src/utils/adapters/types.ts#L155)

...
Defined in: [packages/nova-connect/src/utils/getChainsListByConnectorType.ts:97](https://github.com/TuwaIO/nova-uikit/blob/a56fa44d61411588ad86584ed203077a8886c2ae/packages/nova-connect/src/utils/getChainsListByConnectorType.ts#L97)

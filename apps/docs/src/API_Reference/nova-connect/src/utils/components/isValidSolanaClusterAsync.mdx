...
Defined in: [packages/nova-connect/src/utils/getChainsListByConnectorType.ts:375](https://github.com/TuwaIO/nova-uikit/blob/c40600e69b59dad5140d18003241e83f047dd531/packages/nova-connect/src/utils/getChainsListByConnectorType.ts#L375)

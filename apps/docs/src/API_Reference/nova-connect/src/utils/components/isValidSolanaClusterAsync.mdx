...
Defined in: [packages/nova-connect/src/utils/getChainsListByConnectorType.ts:375](https://github.com/TuwaIO/nova-uikit/blob/5b3a21c9e1f68dc7c1192d074cfe0ab07541ed59/packages/nova-connect/src/utils/getChainsListByConnectorType.ts#L375)

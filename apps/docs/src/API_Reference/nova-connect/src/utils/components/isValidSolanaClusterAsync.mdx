...
Defined in: [packages/nova-connect/src/utils/getChainsListByConnectorType.ts:375](https://github.com/TuwaIO/nova-uikit/blob/280b46a6d43acbe403882f872abaf8647e1a970a/packages/nova-connect/src/utils/getChainsListByConnectorType.ts#L375)

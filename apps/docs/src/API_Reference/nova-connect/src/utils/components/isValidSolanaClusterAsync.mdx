...
Defined in: [packages/nova-connect/src/utils/getChainsListByConnectorType.ts:375](https://github.com/TuwaIO/nova-uikit/blob/03ef94cd466aa8d72e8741dc94b0f5bb38ab82ee/packages/nova-connect/src/utils/getChainsListByConnectorType.ts#L375)

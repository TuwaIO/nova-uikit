...
Defined in: [packages/nova-connect/src/utils/getChainsListByConnectorType.ts:155](https://github.com/TuwaIO/nova-uikit/blob/43c7a55d28279132af955bb9753b7b6a8415a597/packages/nova-connect/src/utils/getChainsListByConnectorType.ts#L155)

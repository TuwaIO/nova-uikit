...
Defined in: [packages/nova-connect/src/utils/getChainsListByConnectorType.ts:155](https://github.com/TuwaIO/nova-uikit/blob/1738709b8ce0d519ec918771791299c4e605a58e/packages/nova-connect/src/utils/getChainsListByConnectorType.ts#L155)

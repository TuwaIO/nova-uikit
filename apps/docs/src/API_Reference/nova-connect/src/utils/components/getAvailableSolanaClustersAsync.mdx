...
Defined in: [packages/nova-connect/src/utils/getChainsListByConnectorType.ts:346](https://github.com/TuwaIO/nova-uikit/blob/402000fcbac592928c3d59f8e3e98b619f7f9dbb/packages/nova-connect/src/utils/getChainsListByConnectorType.ts#L346)

...
Defined in: [packages/nova-connect/src/utils/getChainsListByConnectorType.ts:346](https://github.com/TuwaIO/nova-uikit/blob/248b55a3bec3ae6e4ecf5770fc0537f867124ec4/packages/nova-connect/src/utils/getChainsListByConnectorType.ts#L346)

...
Defined in: [packages/nova-connect/src/utils/getChainsListByConnectorType.ts:346](https://github.com/TuwaIO/nova-uikit/blob/30533978de760ad58b9ab15d87aa394796ecc1a5/packages/nova-connect/src/utils/getChainsListByConnectorType.ts#L346)

...
Defined in: [packages/nova-connect/src/utils/getChainsListByConnectorType.ts:346](https://github.com/TuwaIO/nova-uikit/blob/b060bd4b0d9a272d387bcfc5d82eeb09e6211536/packages/nova-connect/src/utils/getChainsListByConnectorType.ts#L346)

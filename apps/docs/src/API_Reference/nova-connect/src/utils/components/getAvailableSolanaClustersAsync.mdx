...
Defined in: [packages/nova-connect/src/utils/getChainsListByConnectorType.ts:346](https://github.com/TuwaIO/nova-uikit/blob/adfdf3d51e9b5c2e8f6ac81ba55bcc672bdc7196/packages/nova-connect/src/utils/getChainsListByConnectorType.ts#L346)

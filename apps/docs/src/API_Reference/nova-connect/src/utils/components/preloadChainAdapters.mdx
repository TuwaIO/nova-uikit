...
Defined in: [packages/nova-connect/src/utils/getChainsListByConnectorType.ts:480](https://github.com/TuwaIO/nova-uikit/blob/bc6cba7c9f14a374d1d7687556fbf7f55afba14e/packages/nova-connect/src/utils/getChainsListByConnectorType.ts#L480)

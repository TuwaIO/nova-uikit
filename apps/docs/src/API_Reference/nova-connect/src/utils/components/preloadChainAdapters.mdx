...
Defined in: [packages/nova-connect/src/utils/getChainsListByConnectorType.ts:480](https://github.com/TuwaIO/nova-uikit/blob/86a7a5404d1274f31bd64805c1041abed286fc96/packages/nova-connect/src/utils/getChainsListByConnectorType.ts#L480)

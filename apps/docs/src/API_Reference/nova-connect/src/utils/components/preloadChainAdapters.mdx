...
Defined in: [packages/nova-connect/src/utils/getChainsListByConnectorType.ts:480](https://github.com/TuwaIO/nova-uikit/blob/9a77661760d2a0bf65a192a604f9deb6e5336765/packages/nova-connect/src/utils/getChainsListByConnectorType.ts#L480)

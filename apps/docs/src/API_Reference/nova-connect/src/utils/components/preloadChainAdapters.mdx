...
Defined in: [packages/nova-connect/src/utils/getChainsListByConnectorType.ts:480](https://github.com/TuwaIO/nova-uikit/blob/e3c5fee57776888006a9c43c1a591390aa53c6a7/packages/nova-connect/src/utils/getChainsListByConnectorType.ts#L480)

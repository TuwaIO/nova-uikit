...
Defined in: [packages/nova-connect/src/utils/getChainsListByConnectorType.ts:480](https://github.com/TuwaIO/nova-uikit/blob/f53edd72269874af57506ccfaf75ad857bc4d02f/packages/nova-connect/src/utils/getChainsListByConnectorType.ts#L480)

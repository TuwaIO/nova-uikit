...
Defined in: [packages/nova-connect/src/utils/getChainsListByConnectorType.ts:474](https://github.com/TuwaIO/nova-uikit/blob/34e33fc2d9a28ab9eb6980db775ee3740ce04383/packages/nova-connect/src/utils/getChainsListByConnectorType.ts#L474)

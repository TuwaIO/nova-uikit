...
Defined in: [packages/nova-connect/src/utils/getChainsListByConnectorType.ts:546](https://github.com/TuwaIO/nova-uikit/blob/61d533c3eb0979577afd0275a3bc45f95a711223/packages/nova-connect/src/utils/getChainsListByConnectorType.ts#L546)

...
Defined in: [packages/nova-connect/src/utils/getChainsListByConnectorType.ts:546](https://github.com/TuwaIO/nova-uikit/blob/127b4a81efa2388d80b9a5949013038209bbc8ae/packages/nova-connect/src/utils/getChainsListByConnectorType.ts#L546)

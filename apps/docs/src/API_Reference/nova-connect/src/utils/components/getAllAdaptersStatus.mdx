...
Defined in: [packages/nova-connect/src/utils/getChainsListByConnectorType.ts:546](https://github.com/TuwaIO/nova-uikit/blob/650c5a1e2e3173b47e4a34d34815300fb4b0c9de/packages/nova-connect/src/utils/getChainsListByConnectorType.ts#L546)

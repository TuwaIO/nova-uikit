...
Defined in: [packages/nova-connect/src/utils/getChainsListByConnectorType.ts:546](https://github.com/TuwaIO/nova-uikit/blob/05f72e47ba79f1cf90d44eabeb36847d8d68c7e1/packages/nova-connect/src/utils/getChainsListByConnectorType.ts#L546)

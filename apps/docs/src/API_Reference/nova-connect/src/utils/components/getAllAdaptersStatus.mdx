...
Defined in: [packages/nova-connect/src/utils/getChainsListByConnectorType.ts:546](https://github.com/TuwaIO/nova-uikit/blob/4a3362dd6acbb7d90d956b47fc9aa8d67f8672c1/packages/nova-connect/src/utils/getChainsListByConnectorType.ts#L546)

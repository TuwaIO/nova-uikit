...
Defined in: [packages/nova-connect/src/utils/getChainsListByConnectorType.ts:546](https://github.com/TuwaIO/nova-uikit/blob/2620a40d60ee55a58e7c4fb8039d8e622bc23758/packages/nova-connect/src/utils/getChainsListByConnectorType.ts#L546)

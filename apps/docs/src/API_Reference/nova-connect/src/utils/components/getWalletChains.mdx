...
Defined in: [packages/nova-connect/src/utils/getChainsListByConnectorType.ts:426](https://github.com/TuwaIO/nova-uikit/blob/6612571bcefa1284ccf54de5fac8abf60af3205d/packages/nova-connect/src/utils/getChainsListByConnectorType.ts#L426)

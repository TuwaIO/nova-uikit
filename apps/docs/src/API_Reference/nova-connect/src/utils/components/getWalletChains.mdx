...
Defined in: [packages/nova-connect/src/utils/getChainsListByConnectorType.ts:426](https://github.com/TuwaIO/nova-uikit/blob/45798aa1ee6ab77b4f5328f2389a6278fd24f5c9/packages/nova-connect/src/utils/getChainsListByConnectorType.ts#L426)

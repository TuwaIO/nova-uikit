...
Defined in: [packages/nova-connect/src/utils/getChainsListByConnectorType.ts:426](https://github.com/TuwaIO/nova-uikit/blob/265b18b87577f676e8ac8a897249fa78886bd2cf/packages/nova-connect/src/utils/getChainsListByConnectorType.ts#L426)

...
Defined in: node\_modules/.pnpm/@tuwaio+satellite-react@1.0.0-fix-watchers-alpha.1.39245f5\_tshbfnas5izyesqmqpfkrp3kcu/node\_modules/@tuwaio/satellite-react/dist/solana/index.d.ts:15

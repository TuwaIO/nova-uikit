...
Defined in: node\_modules/.pnpm/@tuwaio+satellite-react@1.0.0-fix-adapters-independ-alpha.1.82df95a\_1a066a52579780551082b545e28b0120/node\_modules/@tuwaio/satellite-react/dist/solana/index.d.ts:15

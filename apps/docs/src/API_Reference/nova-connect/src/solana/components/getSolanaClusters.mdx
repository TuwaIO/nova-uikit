...
Defined in: [packages/nova-connect/src/solana/utils.ts:47](https://github.com/TuwaIO/nova-uikit/blob/e8ec05d839f539307762ec792a0848f9d88ecf8f/packages/nova-connect/src/solana/utils.ts#L47)

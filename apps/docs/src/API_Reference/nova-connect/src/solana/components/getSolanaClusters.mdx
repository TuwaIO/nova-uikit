...
Defined in: [packages/nova-connect/src/solana/utils.ts:47](https://github.com/TuwaIO/nova-uikit/blob/f8fbd4bb56f345752167ec5638defb147ac53936/packages/nova-connect/src/solana/utils.ts#L47)

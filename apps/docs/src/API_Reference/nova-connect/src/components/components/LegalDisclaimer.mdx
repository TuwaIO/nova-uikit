...
Defined in: [packages/nova-connect/src/components/ConnectModal/LegalDisclaimer.tsx:244](https://github.com/TuwaIO/nova-uikit/blob/e39d56f72a0d69fcbe1c73aca2bc0f1499b0d403/packages/nova-connect/src/components/ConnectModal/LegalDisclaimer.tsx#L244)

...
Defined in: [packages/nova-connect/src/components/ConnectModal/LegalDisclaimer.tsx:244](https://github.com/TuwaIO/nova-uikit/blob/efbfbdd3a187f7be0d3504ddf49fc2b01d8fea7c/packages/nova-connect/src/components/ConnectModal/LegalDisclaimer.tsx#L244)

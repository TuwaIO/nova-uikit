...
Defined in: [packages/nova-connect/src/components/ConnectModal/LegalDisclaimer.tsx:244](https://github.com/TuwaIO/nova-uikit/blob/e3c5fee57776888006a9c43c1a591390aa53c6a7/packages/nova-connect/src/components/ConnectModal/LegalDisclaimer.tsx#L244)

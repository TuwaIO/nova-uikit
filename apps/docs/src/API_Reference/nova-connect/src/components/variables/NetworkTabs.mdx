...
Defined in: [packages/nova-connect/src/components/ConnectModal/NetworkTabs.tsx:417](https://github.com/TuwaIO/nova-uikit/blob/0170c260d47c77e8c6c28078147cdc52b5eb75b8/packages/nova-connect/src/components/ConnectModal/NetworkTabs.tsx#L417)

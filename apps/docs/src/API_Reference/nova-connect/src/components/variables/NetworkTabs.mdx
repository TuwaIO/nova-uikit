...
Defined in: [packages/nova-connect/src/components/ConnectModal/NetworkTabs.tsx:417](https://github.com/TuwaIO/nova-uikit/blob/9923b6743ef5de47eb9647ea59d41a396c8ee23c/packages/nova-connect/src/components/ConnectModal/NetworkTabs.tsx#L417)

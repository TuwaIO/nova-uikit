...
> `const` **ConnectedModal**: `ForwardRefExoticComponent`\<[`ConnectedModalProps`](?path=/docs/api-reference-nova-connect-src-components-interfaces-connectedmodalprops--docs) & `RefAttributes`\<`HTMLDivElement`\>\>

Defined in: [packages/nova-connect/src/components/ConnectedModal/ConnectedModal.tsx:586](https://github.com/TuwaIO/nova-uikit/blob/dfcdaa7c2be59b53b761bfc04021ce5e498698c8/packages/nova-connect/src/components/ConnectedModal/ConnectedModal.tsx#L586)

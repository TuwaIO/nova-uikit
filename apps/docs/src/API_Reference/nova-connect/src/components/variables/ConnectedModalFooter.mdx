...
> `const` **ConnectedModalFooter**: `ForwardRefExoticComponent`\<[`ConnectedModalFooterProps`](?path=/docs/api-reference-nova-connect-src-components-interfaces-connectedmodalfooterprops--docs) & `RefAttributes`\<`HTMLElement`\>\>

Defined in: [packages/nova-connect/src/components/ConnectedModal/ConnectedModalFooter.tsx:497](https://github.com/TuwaIO/nova-uikit/blob/1738709b8ce0d519ec918771791299c4e605a58e/packages/nova-connect/src/components/ConnectedModal/ConnectedModalFooter.tsx#L497)

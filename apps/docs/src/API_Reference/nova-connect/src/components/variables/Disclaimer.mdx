...
> `const` **Disclaimer**: `ForwardRefExoticComponent`\<[`DisclaimerProps`](?path=/docs/api-reference-nova-connect-src-components-interfaces-disclaimerprops--docs) & `RefAttributes`\<`HTMLDivElement`\>\>

Defined in: [packages/nova-connect/src/components/ConnectModal/Disclaimer.tsx:333](https://github.com/TuwaIO/nova-uikit/blob/96dae07fda7b200f2f0bdb59111a304c9a56777c/packages/nova-connect/src/components/ConnectModal/Disclaimer.tsx#L333)

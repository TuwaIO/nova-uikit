...
Defined in: [packages/nova-connect/src/components/ConnectModal/ConnectCard.tsx:615](https://github.com/TuwaIO/nova-uikit/blob/d4ab29a269e2064b7291c30a99f51f56df6cdfa4/packages/nova-connect/src/components/ConnectModal/ConnectCard.tsx#L615)

...
Defined in: [packages/nova-connect/src/components/ConnectModal/ConnectCard.tsx:615](https://github.com/TuwaIO/nova-uikit/blob/2d1091bb5800cccbeda906a1df467d38b3fd885a/packages/nova-connect/src/components/ConnectModal/ConnectCard.tsx#L615)

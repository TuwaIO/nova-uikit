...
Defined in: [packages/nova-connect/src/components/ConnectButton/ConnectedContent.tsx:272](https://github.com/TuwaIO/nova-uikit/blob/3b9837e67f91a5c75a7b9eee850374da792ade55/packages/nova-connect/src/components/ConnectButton/ConnectedContent.tsx#L272)

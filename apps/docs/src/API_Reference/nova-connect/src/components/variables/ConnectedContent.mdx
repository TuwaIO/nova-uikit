...
Defined in: [packages/nova-connect/src/components/ConnectButton/ConnectedContent.tsx:272](https://github.com/TuwaIO/nova-uikit/blob/474eae540b971ef7866a6fc2fc4f9fe24990550b/packages/nova-connect/src/components/ConnectButton/ConnectedContent.tsx#L272)

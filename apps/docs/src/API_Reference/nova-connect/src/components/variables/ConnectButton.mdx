...
Defined in: [packages/nova-connect/src/components/ConnectButton/ConnectButton.tsx:238](https://github.com/TuwaIO/nova-uikit/blob/bf13b0b68078cbae114ed893fd97741fa3ceb8a3/packages/nova-connect/src/components/ConnectButton/ConnectButton.tsx#L238)

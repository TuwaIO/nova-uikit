...
Defined in: [packages/nova-connect/src/components/ConnectModal/Connecting.tsx:403](https://github.com/TuwaIO/nova-uikit/blob/1290bd5fcb87b80bf1b92ff578128cd4c87c5d59/packages/nova-connect/src/components/ConnectModal/Connecting.tsx#L403)

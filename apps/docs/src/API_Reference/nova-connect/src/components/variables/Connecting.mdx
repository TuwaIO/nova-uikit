...
Defined in: [packages/nova-connect/src/components/ConnectModal/Connecting.tsx:403](https://github.com/TuwaIO/nova-uikit/blob/04403b0b691bd17ed01b6b76ed63a08911a72369/packages/nova-connect/src/components/ConnectModal/Connecting.tsx#L403)

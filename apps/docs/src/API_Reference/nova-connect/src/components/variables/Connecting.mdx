...
Defined in: [packages/nova-connect/src/components/ConnectModal/Connecting.tsx:405](https://github.com/TuwaIO/nova-uikit/blob/c703051f471b8888ecba7b1d96c42cc8aec087db/packages/nova-connect/src/components/ConnectModal/Connecting.tsx#L405)

...
Defined in: [packages/nova-connect/src/components/SelectContentAnimated.tsx:101](https://github.com/TuwaIO/nova-uikit/blob/34b3ede0a7907f0a152d0a759f44f9a21c8276cf/packages/nova-connect/src/components/SelectContentAnimated.tsx#L101)

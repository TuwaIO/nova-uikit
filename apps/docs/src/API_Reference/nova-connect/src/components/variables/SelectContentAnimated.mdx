...
Defined in: [packages/nova-connect/src/components/SelectContentAnimated.tsx:101](https://github.com/TuwaIO/nova-uikit/blob/d65289b5458451f6136f05aade7c9cfedc1497a9/packages/nova-connect/src/components/SelectContentAnimated.tsx#L101)

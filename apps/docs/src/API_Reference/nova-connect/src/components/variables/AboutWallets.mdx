...
Defined in: [packages/nova-connect/src/components/ConnectModal/AboutWallets.tsx:510](https://github.com/TuwaIO/nova-uikit/blob/04403b0b691bd17ed01b6b76ed63a08911a72369/packages/nova-connect/src/components/ConnectModal/AboutWallets.tsx#L510)

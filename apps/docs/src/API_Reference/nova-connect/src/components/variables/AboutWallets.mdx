...
Defined in: [packages/nova-connect/src/components/ConnectModal/AboutWallets.tsx:510](https://github.com/TuwaIO/nova-uikit/blob/bf13b0b68078cbae114ed893fd97741fa3ceb8a3/packages/nova-connect/src/components/ConnectModal/AboutWallets.tsx#L510)

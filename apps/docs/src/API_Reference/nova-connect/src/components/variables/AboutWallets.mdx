...
Defined in: [packages/nova-connect/src/components/ConnectModal/AboutWallets.tsx:586](https://github.com/TuwaIO/nova-uikit/blob/e62ccc8b4b22c15651ac3910a0b6dbaf2781b56b/packages/nova-connect/src/components/ConnectModal/AboutWallets.tsx#L586)

...
Defined in: [packages/nova-connect/src/components/ConnectModal/AboutWallets.tsx:509](https://github.com/TuwaIO/nova-uikit/blob/e7c1cfd17ddef8454a0c4e7eae2f6e7adc0dff84/packages/nova-connect/src/components/ConnectModal/AboutWallets.tsx#L509)

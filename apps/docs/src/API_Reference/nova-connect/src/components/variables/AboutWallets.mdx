...
Defined in: [packages/nova-connect/src/components/ConnectModal/AboutWallets.tsx:586](https://github.com/TuwaIO/nova-uikit/blob/2a29c5b30cda9e68c51018a06a5b069a47c23130/packages/nova-connect/src/components/ConnectModal/AboutWallets.tsx#L586)

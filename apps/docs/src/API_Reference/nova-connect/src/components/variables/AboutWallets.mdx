...
Defined in: [packages/nova-connect/src/components/ConnectModal/AboutWallets.tsx:509](https://github.com/TuwaIO/nova-uikit/blob/a295e4da0d28abf566dfbd16e3215e0cced7f514/packages/nova-connect/src/components/ConnectModal/AboutWallets.tsx#L509)

...
> `const` **StatusIcon**: `ForwardRefExoticComponent`\<`Omit`\<[`StatusIconProps`](?path=/docs/api-reference-nova-connect-src-components-interfaces-statusiconprops--docs), `"ref"`\> & `RefAttributes`\<`HTMLDivElement`\>\>

Defined in: [packages/nova-connect/src/components/ConnectButton/StatusIcon.tsx:251](https://github.com/TuwaIO/nova-uikit/blob/061e66e258d305abb584390ba85ec4539a700037/packages/nova-connect/src/components/ConnectButton/StatusIcon.tsx#L251)

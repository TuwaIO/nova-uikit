...
Defined in: [packages/nova-connect/src/components/ConnectButton/StatusIcon.tsx:251](https://github.com/TuwaIO/nova-uikit/blob/3762c2e40253ee8f488b8bfe5c25530175641c99/packages/nova-connect/src/components/ConnectButton/StatusIcon.tsx#L251)

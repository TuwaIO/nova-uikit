...
Defined in: [packages/nova-connect/src/components/ConnectButton/StatusIcon.tsx:251](https://github.com/TuwaIO/nova-uikit/blob/ec9f25ddba9623ed0a922e6e36541af5128f314a/packages/nova-connect/src/components/ConnectButton/StatusIcon.tsx#L251)

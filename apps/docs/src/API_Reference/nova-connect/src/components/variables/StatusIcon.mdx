...
Defined in: [packages/nova-connect/src/components/ConnectButton/StatusIcon.tsx:252](https://github.com/TuwaIO/nova-uikit/blob/bc09cf65a4e57a1bf4a3d7b52aa2642c7fe7fc12/packages/nova-connect/src/components/ConnectButton/StatusIcon.tsx#L252)

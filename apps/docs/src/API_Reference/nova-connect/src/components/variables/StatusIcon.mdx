...
Defined in: [packages/nova-connect/src/components/ConnectButton/StatusIcon.tsx:252](https://github.com/TuwaIO/nova-uikit/blob/5462fb54238f6ce4bfb98420a102fdb6be1aa77c/packages/nova-connect/src/components/ConnectButton/StatusIcon.tsx#L252)

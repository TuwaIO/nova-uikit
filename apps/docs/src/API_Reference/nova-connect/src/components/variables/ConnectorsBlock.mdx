...
Defined in: [packages/nova-connect/src/components/ConnectModal/ConnectorsBlock.tsx:353](https://github.com/TuwaIO/nova-uikit/blob/280b46a6d43acbe403882f872abaf8647e1a970a/packages/nova-connect/src/components/ConnectModal/ConnectorsBlock.tsx#L353)

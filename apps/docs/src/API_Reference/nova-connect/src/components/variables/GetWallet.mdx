...
Defined in: [packages/nova-connect/src/components/ConnectModal/GetWallet.tsx:514](https://github.com/TuwaIO/nova-uikit/blob/23e4e6e2e355e311d4cbb417175ddf064901efc5/packages/nova-connect/src/components/ConnectModal/GetWallet.tsx#L514)

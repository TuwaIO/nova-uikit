...
Defined in: [packages/nova-connect/src/components/ConnectModal/GetWallet.tsx:514](https://github.com/TuwaIO/nova-uikit/blob/4d120231ea20ad03257b039d3f79a2633fc05e23/packages/nova-connect/src/components/ConnectModal/GetWallet.tsx#L514)

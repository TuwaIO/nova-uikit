...
Defined in: [packages/nova-connect/src/components/ConnectModal/GetWallet.tsx:517](https://github.com/TuwaIO/nova-uikit/blob/402000fcbac592928c3d59f8e3e98b619f7f9dbb/packages/nova-connect/src/components/ConnectModal/GetWallet.tsx#L517)

...
Defined in: [packages/nova-connect/src/components/ConnectModal/GetWallet.tsx:514](https://github.com/TuwaIO/nova-uikit/blob/2c6b235ec664678c8d709d9d74d3ba16652a3e5e/packages/nova-connect/src/components/ConnectModal/GetWallet.tsx#L514)

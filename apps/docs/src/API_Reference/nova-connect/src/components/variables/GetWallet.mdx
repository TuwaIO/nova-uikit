...
Defined in: [packages/nova-connect/src/components/ConnectModal/GetWallet.tsx:518](https://github.com/TuwaIO/nova-uikit/blob/87edf14a53bcd38d8a8f88f413cce1434acadc16/packages/nova-connect/src/components/ConnectModal/GetWallet.tsx#L518)

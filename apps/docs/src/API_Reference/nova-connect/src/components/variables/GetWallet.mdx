...
Defined in: [packages/nova-connect/src/components/ConnectModal/GetWallet.tsx:514](https://github.com/TuwaIO/nova-uikit/blob/a46a4afcb2f3628c18865d358e90ae52be57d456/packages/nova-connect/src/components/ConnectModal/GetWallet.tsx#L514)

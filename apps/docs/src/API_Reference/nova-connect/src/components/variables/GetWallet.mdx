...
Defined in: [packages/nova-connect/src/components/ConnectModal/GetWallet.tsx:514](https://github.com/TuwaIO/nova-uikit/blob/1a41352d12476bd095d971180a60a22554d0fa26/packages/nova-connect/src/components/ConnectModal/GetWallet.tsx#L514)

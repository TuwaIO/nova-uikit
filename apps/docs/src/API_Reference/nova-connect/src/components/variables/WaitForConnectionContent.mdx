...
Defined in: [packages/nova-connect/src/components/ConnectButton/WaitForConnectionContent.tsx:277](https://github.com/TuwaIO/nova-uikit/blob/e39d56f72a0d69fcbe1c73aca2bc0f1499b0d403/packages/nova-connect/src/components/ConnectButton/WaitForConnectionContent.tsx#L277)

...
Defined in: [packages/nova-connect/src/components/ConnectButton/WaitForConnectionContent.tsx:277](https://github.com/TuwaIO/nova-uikit/blob/9c0f2bdb05c1c45f902d325c907c47a35e5ab741/packages/nova-connect/src/components/ConnectButton/WaitForConnectionContent.tsx#L277)

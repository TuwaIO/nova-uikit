...
Defined in: [packages/nova-connect/src/components/ConnectButton/WaitForConnectionContent.tsx:277](https://github.com/TuwaIO/nova-uikit/blob/dc117afd81fc2d623aa639fe4ff7b7e8b2dc92be/packages/nova-connect/src/components/ConnectButton/WaitForConnectionContent.tsx#L277)

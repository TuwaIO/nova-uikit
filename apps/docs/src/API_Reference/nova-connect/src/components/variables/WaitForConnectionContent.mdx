...
Defined in: [packages/nova-connect/src/components/ConnectButton/WaitForConnectionContent.tsx:277](https://github.com/TuwaIO/nova-uikit/blob/790a29c5ede3e3788a97ba45960b24f4fd414cc0/packages/nova-connect/src/components/ConnectButton/WaitForConnectionContent.tsx#L277)

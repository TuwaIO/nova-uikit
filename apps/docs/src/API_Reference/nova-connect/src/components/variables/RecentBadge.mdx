...
Defined in: [packages/nova-connect/src/components/ConnectModal/RecentBadge.tsx:294](https://github.com/TuwaIO/nova-uikit/blob/7a210c0ecc4043ba26cbaecdbd2d557ac81e9c59/packages/nova-connect/src/components/ConnectModal/RecentBadge.tsx#L294)

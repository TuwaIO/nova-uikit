...
Defined in: [packages/nova-connect/src/components/ConnectModal/RecentBadge.tsx:291](https://github.com/TuwaIO/nova-uikit/blob/790a29c5ede3e3788a97ba45960b24f4fd414cc0/packages/nova-connect/src/components/ConnectModal/RecentBadge.tsx#L291)

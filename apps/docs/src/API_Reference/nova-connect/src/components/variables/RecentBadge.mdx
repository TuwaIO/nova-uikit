...
Defined in: [packages/nova-connect/src/components/ConnectModal/RecentBadge.tsx:291](https://github.com/TuwaIO/nova-uikit/blob/d9cb0592017ba8785db83187dd0a7191551b65f5/packages/nova-connect/src/components/ConnectModal/RecentBadge.tsx#L291)

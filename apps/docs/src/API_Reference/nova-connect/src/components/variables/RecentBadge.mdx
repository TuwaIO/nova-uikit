...
Defined in: [packages/nova-connect/src/components/ConnectModal/RecentBadge.tsx:291](https://github.com/TuwaIO/nova-uikit/blob/0735e7bf4b6ce9d93d118a506932d9f3162abce9/packages/nova-connect/src/components/ConnectModal/RecentBadge.tsx#L291)

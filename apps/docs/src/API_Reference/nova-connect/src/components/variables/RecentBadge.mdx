...
Defined in: [packages/nova-connect/src/components/ConnectModal/RecentBadge.tsx:294](https://github.com/TuwaIO/nova-uikit/blob/34b3ede0a7907f0a152d0a759f44f9a21c8276cf/packages/nova-connect/src/components/ConnectModal/RecentBadge.tsx#L294)

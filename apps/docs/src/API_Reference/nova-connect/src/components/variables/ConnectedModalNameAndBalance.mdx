...
Defined in: [packages/nova-connect/src/components/ConnectedModal/ConnectedModalNameAndBalance.tsx:453](https://github.com/TuwaIO/nova-uikit/blob/3b601525e0a7def91d7ef8a4b0fa6992a1c63862/packages/nova-connect/src/components/ConnectedModal/ConnectedModalNameAndBalance.tsx#L453)

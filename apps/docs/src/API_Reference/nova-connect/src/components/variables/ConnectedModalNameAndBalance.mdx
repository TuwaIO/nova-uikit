...
> `const` **ConnectedModalNameAndBalance**: `ForwardRefExoticComponent`\<[`ConnectedModalNameAndBalanceProps`](?path=/docs/api-reference-nova-connect-src-components-interfaces-connectedmodalnameandbalanceprops--docs) & `RefAttributes`\<`HTMLElement`\>\>

Defined in: [packages/nova-connect/src/components/ConnectedModal/ConnectedModalNameAndBalance.tsx:453](https://github.com/TuwaIO/nova-uikit/blob/c0db82e602c2808e615dbad63954e84aea39b4b2/packages/nova-connect/src/components/ConnectedModal/ConnectedModalNameAndBalance.tsx#L453)

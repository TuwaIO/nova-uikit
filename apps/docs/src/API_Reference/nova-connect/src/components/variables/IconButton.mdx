...
Defined in: [packages/nova-connect/src/components/ConnectedModal/IconButton.tsx:367](https://github.com/TuwaIO/nova-uikit/blob/b060bd4b0d9a272d387bcfc5d82eeb09e6211536/packages/nova-connect/src/components/ConnectedModal/IconButton.tsx#L367)

...
Defined in: [packages/nova-connect/src/components/ConnectedModal/IconButton.tsx:368](https://github.com/TuwaIO/nova-uikit/blob/e08f8f0af2816ec4f866c050f053f88532b89784/packages/nova-connect/src/components/ConnectedModal/IconButton.tsx#L368)

...
Defined in: [packages/nova-connect/src/components/ConnectedModal/IconButton.tsx:368](https://github.com/TuwaIO/nova-uikit/blob/2a3c4ab549f3e82043dd5b87241fd0e22f869649/packages/nova-connect/src/components/ConnectedModal/IconButton.tsx#L368)

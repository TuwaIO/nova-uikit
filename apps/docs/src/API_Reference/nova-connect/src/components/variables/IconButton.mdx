...
> `const` **IconButton**: `ForwardRefExoticComponent`\<[`IconButtonProps`](?path=/docs/api-reference-nova-connect-src-components-interfaces-iconbuttonprops--docs) & `RefAttributes`\<`Omit`\<`HTMLButtonElement`, `"style"`\>\>\>

Defined in: [packages/nova-connect/src/components/ConnectedModal/IconButton.tsx:367](https://github.com/TuwaIO/nova-uikit/blob/53e7b18341c662e9829e32ebfad915e1004beda0/packages/nova-connect/src/components/ConnectedModal/IconButton.tsx#L367)
...
**Interactive chain selector with customization**

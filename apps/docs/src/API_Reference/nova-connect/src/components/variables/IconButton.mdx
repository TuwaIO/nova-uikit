...
Defined in: [packages/nova-connect/src/components/ConnectedModal/IconButton.tsx:367](https://github.com/TuwaIO/nova-uikit/blob/bc6cba7c9f14a374d1d7687556fbf7f55afba14e/packages/nova-connect/src/components/ConnectedModal/IconButton.tsx#L367)

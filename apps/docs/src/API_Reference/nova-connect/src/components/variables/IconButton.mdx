...
Defined in: [packages/nova-connect/src/components/ConnectedModal/IconButton.tsx:367](https://github.com/TuwaIO/nova-uikit/blob/efcfc815c7c447b7a40b53ff9bec9f2170d83c1d/packages/nova-connect/src/components/ConnectedModal/IconButton.tsx#L367)

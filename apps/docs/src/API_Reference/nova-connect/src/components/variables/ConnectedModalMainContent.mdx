...
Defined in: [packages/nova-connect/src/components/ConnectedModal/ConnectedModalMainContent.tsx:575](https://github.com/TuwaIO/nova-uikit/blob/5c63ec96aee9f5be7aff8185ccbdd19f8097c126/packages/nova-connect/src/components/ConnectedModal/ConnectedModalMainContent.tsx#L575)

...
Defined in: [packages/nova-connect/src/components/ConnectedModal/ConnectedModalMainContent.tsx:574](https://github.com/TuwaIO/nova-uikit/blob/d4ab29a269e2064b7291c30a99f51f56df6cdfa4/packages/nova-connect/src/components/ConnectedModal/ConnectedModalMainContent.tsx#L574)

...
Defined in: [packages/nova-connect/src/components/ConnectedModal/ConnectedModalMainContent.tsx:546](https://github.com/TuwaIO/nova-uikit/blob/c4af3263fcbf9bf84b5b2ada0b7233e94ebd44f7/packages/nova-connect/src/components/ConnectedModal/ConnectedModalMainContent.tsx#L546)

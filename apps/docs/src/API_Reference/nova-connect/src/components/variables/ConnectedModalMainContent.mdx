...
Defined in: [packages/nova-connect/src/components/ConnectedModal/ConnectedModalMainContent.tsx:575](https://github.com/TuwaIO/nova-uikit/blob/d674a29a62fa46c8aca96808741d8f4976712c8a/packages/nova-connect/src/components/ConnectedModal/ConnectedModalMainContent.tsx#L575)

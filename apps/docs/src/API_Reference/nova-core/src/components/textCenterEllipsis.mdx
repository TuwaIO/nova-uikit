...
Defined in: [nova-core/src/utils/textCenterEllipsis.ts:20](https://github.com/TuwaIO/nova-uikit/blob/5d7b31a3eb303ddeae8246ceedaaddcd635e55da/packages/nova-core/src/utils/textCenterEllipsis.ts#L20)

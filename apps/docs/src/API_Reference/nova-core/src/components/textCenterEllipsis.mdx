...
Defined in: [packages/nova-core/src/utils/textCenterEllipsis.ts:20](https://github.com/TuwaIO/nova-uikit/blob/2ae3a349604a64908af94ae1f3372a75a95a5510/packages/nova-core/src/utils/textCenterEllipsis.ts#L20)

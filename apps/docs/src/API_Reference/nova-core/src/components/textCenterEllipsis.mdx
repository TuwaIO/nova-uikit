...
Defined in: [packages/nova-core/src/utils/textCenterEllipsis.ts:20](https://github.com/TuwaIO/nova-uikit/blob/5462fb54238f6ce4bfb98420a102fdb6be1aa77c/packages/nova-core/src/utils/textCenterEllipsis.ts#L20)

...
Defined in: [packages/nova-core/src/components/NetworkIcon.tsx:47](https://github.com/TuwaIO/nova-uikit/blob/efbfbdd3a187f7be0d3504ddf49fc2b01d8fea7c/packages/nova-core/src/components/NetworkIcon.tsx#L47)

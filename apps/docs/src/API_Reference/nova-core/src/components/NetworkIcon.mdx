...
Defined in: [packages/nova-core/src/components/NetworkIcon.tsx:47](https://github.com/TuwaIO/nova-uikit/blob/474eae540b971ef7866a6fc2fc4f9fe24990550b/packages/nova-core/src/components/NetworkIcon.tsx#L47)

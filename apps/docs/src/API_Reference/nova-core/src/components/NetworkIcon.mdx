...
Defined in: [packages/nova-core/src/components/NetworkIcon.tsx:47](https://github.com/TuwaIO/nova-uikit/blob/d4ab29a269e2064b7291c30a99f51f56df6cdfa4/packages/nova-core/src/components/NetworkIcon.tsx#L47)

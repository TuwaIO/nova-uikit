...
Defined in: [packages/nova-core/src/components/WalletIcon.tsx:73](https://github.com/TuwaIO/nova-uikit/blob/584277c0cd25dcb7d9e92c6efce611540916dbfd/packages/nova-core/src/components/WalletIcon.tsx#L73)

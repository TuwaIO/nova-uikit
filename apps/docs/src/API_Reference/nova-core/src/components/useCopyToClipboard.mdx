...
Defined in: [nova-core/src/hooks/useCopyToClipboard.ts:30](https://github.com/TuwaIO/nova-uikit/blob/4b8f114134c9a2055055f3192fbe0a69c2544cc3/packages/nova-core/src/hooks/useCopyToClipboard.ts#L30)

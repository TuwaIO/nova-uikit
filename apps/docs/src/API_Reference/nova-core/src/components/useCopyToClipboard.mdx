...
Defined in: [packages/nova-core/src/hooks/useCopyToClipboard.ts:30](https://github.com/TuwaIO/nova-uikit/blob/f8fbd4bb56f345752167ec5638defb147ac53936/packages/nova-core/src/hooks/useCopyToClipboard.ts#L30)

...
Defined in: [packages/nova-core/src/hooks/useCopyToClipboard.ts:30](https://github.com/TuwaIO/nova-uikit/blob/f227d130007d40907dfb21ddf99a3a7d098f9afc/packages/nova-core/src/hooks/useCopyToClipboard.ts#L30)

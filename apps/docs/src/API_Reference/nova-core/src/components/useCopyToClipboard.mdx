...
Defined in: [packages/nova-core/src/hooks/useCopyToClipboard.ts:30](https://github.com/TuwaIO/nova-uikit/blob/63d93779bde97fe7daf4313e46d7ca89e15beddc/packages/nova-core/src/hooks/useCopyToClipboard.ts#L30)

...
Defined in: [packages/nova-core/src/hooks/useCopyToClipboard.ts:30](https://github.com/TuwaIO/nova-uikit/blob/3d81d38b3bdf03aa9a20295db90d883be2a86306/packages/nova-core/src/hooks/useCopyToClipboard.ts#L30)

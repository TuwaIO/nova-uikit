...
Defined in: [nova-core/src/hooks/useCopyToClipboard.ts:30](https://github.com/TuwaIO/nova-uikit/blob/37786c480a824fa538051d78762f2a843e7b3f9e/packages/nova-core/src/hooks/useCopyToClipboard.ts#L30)

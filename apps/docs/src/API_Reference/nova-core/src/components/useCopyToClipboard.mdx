...
Defined in: [nova-core/src/hooks/useCopyToClipboard.ts:30](https://github.com/TuwaIO/nova-uikit/blob/2f665947b9a0d37380afaefdca7a12c5dd5af844/packages/nova-core/src/hooks/useCopyToClipboard.ts#L30)

...
Defined in: [packages/nova-core/src/hooks/useCopyToClipboard.ts:30](https://github.com/TuwaIO/nova-uikit/blob/03d1b99d0a23e3b8c201eed9bee0ec07c679297e/packages/nova-core/src/hooks/useCopyToClipboard.ts#L30)

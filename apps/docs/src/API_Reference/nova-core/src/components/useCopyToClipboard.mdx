...
Defined in: [packages/nova-core/src/hooks/useCopyToClipboard.ts:30](https://github.com/TuwaIO/nova-uikit/blob/9748e2178f0e4f2418f5805315865244af2192b4/packages/nova-core/src/hooks/useCopyToClipboard.ts#L30)

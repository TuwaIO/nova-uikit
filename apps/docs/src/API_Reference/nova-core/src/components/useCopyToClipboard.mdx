...
Defined in: [packages/nova-core/src/hooks/useCopyToClipboard.ts:30](https://github.com/TuwaIO/nova-uikit/blob/ee1e0f015aaf08870185132c2f414ffdba29d3c3/packages/nova-core/src/hooks/useCopyToClipboard.ts#L30)

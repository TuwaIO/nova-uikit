...
Defined in: [packages/nova-core/src/hooks/useCopyToClipboard.ts:30](https://github.com/TuwaIO/nova-uikit/blob/e8ec05d839f539307762ec792a0848f9d88ecf8f/packages/nova-core/src/hooks/useCopyToClipboard.ts#L30)

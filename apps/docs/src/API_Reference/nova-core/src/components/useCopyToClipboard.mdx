...
Defined in: [nova-core/src/hooks/useCopyToClipboard.ts:30](https://github.com/TuwaIO/nova-uikit/blob/0b297c472eee91386614e9a3e496df0839899583/packages/nova-core/src/hooks/useCopyToClipboard.ts#L30)

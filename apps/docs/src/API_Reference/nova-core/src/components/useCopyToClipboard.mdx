...
Defined in: [nova-core/src/hooks/useCopyToClipboard.ts:30](https://github.com/TuwaIO/nova-uikit/blob/611ff3c6f869c1dd85d4005cacb055fdb59be697/packages/nova-core/src/hooks/useCopyToClipboard.ts#L30)

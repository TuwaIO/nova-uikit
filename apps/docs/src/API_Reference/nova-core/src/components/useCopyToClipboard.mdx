...
Defined in: [packages/nova-core/src/hooks/useCopyToClipboard.ts:30](https://github.com/TuwaIO/nova-uikit/blob/03ef94cd466aa8d72e8741dc94b0f5bb38ab82ee/packages/nova-core/src/hooks/useCopyToClipboard.ts#L30)

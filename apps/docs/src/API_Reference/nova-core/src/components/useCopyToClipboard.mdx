...
Defined in: [packages/nova-core/src/hooks/useCopyToClipboard.ts:30](https://github.com/TuwaIO/nova-uikit/blob/9a26710ac8b30dc3dfd19fe675eade473607bcdf/packages/nova-core/src/hooks/useCopyToClipboard.ts#L30)

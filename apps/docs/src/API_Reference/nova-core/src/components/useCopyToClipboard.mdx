...
Defined in: [nova-core/src/hooks/useCopyToClipboard.ts:30](https://github.com/TuwaIO/nova-uikit/blob/904600bb8d86484a28970e5cf7522e598a2879e6/packages/nova-core/src/hooks/useCopyToClipboard.ts#L30)

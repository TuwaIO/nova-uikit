...
Defined in: [packages/nova-core/src/hooks/useCopyToClipboard.ts:30](https://github.com/TuwaIO/nova-uikit/blob/7a210c0ecc4043ba26cbaecdbd2d557ac81e9c59/packages/nova-core/src/hooks/useCopyToClipboard.ts#L30)

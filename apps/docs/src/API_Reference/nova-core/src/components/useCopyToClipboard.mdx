...
Defined in: [nova-core/src/hooks/useCopyToClipboard.ts:30](https://github.com/TuwaIO/nova-uikit/blob/858912fffa0bf561cb7bacaa58997e31e14a1e2a/packages/nova-core/src/hooks/useCopyToClipboard.ts#L30)

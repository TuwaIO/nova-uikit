...
Defined in: [packages/nova-core/src/hooks/useCopyToClipboard.ts:30](https://github.com/TuwaIO/nova-uikit/blob/d38d6f8540a30932c774837acc9e2bec3fab75df/packages/nova-core/src/hooks/useCopyToClipboard.ts#L30)

...
Defined in: [nova-core/src/hooks/useCopyToClipboard.ts:30](https://github.com/TuwaIO/nova-uikit/blob/ed2e28d6e7d892b508553a9859b307eb832fe4c1/packages/nova-core/src/hooks/useCopyToClipboard.ts#L30)

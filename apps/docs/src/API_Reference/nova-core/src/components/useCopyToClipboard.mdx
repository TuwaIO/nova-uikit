...
Defined in: [packages/nova-core/src/hooks/useCopyToClipboard.ts:30](https://github.com/TuwaIO/nova-uikit/blob/a2fec1546b58c024e38b90bc843fd1315e411402/packages/nova-core/src/hooks/useCopyToClipboard.ts#L30)

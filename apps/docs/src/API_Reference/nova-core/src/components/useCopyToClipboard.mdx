...
Defined in: [packages/nova-core/src/hooks/useCopyToClipboard.ts:30](https://github.com/TuwaIO/nova-uikit/blob/a6935ad165181db46094cc50c0501928d06a176c/packages/nova-core/src/hooks/useCopyToClipboard.ts#L30)

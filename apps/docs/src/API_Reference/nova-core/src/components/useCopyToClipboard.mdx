...
Defined in: [packages/nova-core/src/hooks/useCopyToClipboard.ts:30](https://github.com/TuwaIO/nova-uikit/blob/04403b0b691bd17ed01b6b76ed63a08911a72369/packages/nova-core/src/hooks/useCopyToClipboard.ts#L30)

...
Defined in: [nova-core/src/hooks/useCopyToClipboard.ts:30](https://github.com/TuwaIO/nova-uikit/blob/ece038bfcc92e1d5da07dbae62f4eccfaef52328/packages/nova-core/src/hooks/useCopyToClipboard.ts#L30)

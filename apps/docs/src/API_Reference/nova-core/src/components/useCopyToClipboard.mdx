...
Defined in: [packages/nova-core/src/hooks/useCopyToClipboard.ts:30](https://github.com/TuwaIO/nova-uikit/blob/de8bac39e15b4993550215cf3f0a1afe317b2eae/packages/nova-core/src/hooks/useCopyToClipboard.ts#L30)

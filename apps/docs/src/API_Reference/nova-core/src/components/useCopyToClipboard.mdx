...
Defined in: [packages/nova-core/src/hooks/useCopyToClipboard.ts:30](https://github.com/TuwaIO/nova-uikit/blob/549f0ede841f8cdc97219fa4c1f558428cb94695/packages/nova-core/src/hooks/useCopyToClipboard.ts#L30)

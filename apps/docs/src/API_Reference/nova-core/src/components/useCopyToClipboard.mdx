...
Defined in: [nova-core/src/hooks/useCopyToClipboard.ts:30](https://github.com/TuwaIO/nova-uikit/blob/4b877e5de18d002fe5c470bf137b01e9db4fd576/packages/nova-core/src/hooks/useCopyToClipboard.ts#L30)

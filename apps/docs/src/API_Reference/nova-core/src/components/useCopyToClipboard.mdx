...
Defined in: [nova-core/src/hooks/useCopyToClipboard.ts:30](https://github.com/TuwaIO/nova-uikit/blob/b4b07a699985b6b62e51480ca63064005b2848bc/packages/nova-core/src/hooks/useCopyToClipboard.ts#L30)

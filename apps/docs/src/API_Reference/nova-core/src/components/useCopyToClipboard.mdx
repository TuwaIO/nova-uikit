...
Defined in: [nova-core/src/hooks/useCopyToClipboard.ts:30](https://github.com/TuwaIO/nova-uikit/blob/814d2188e3e0215a28f4d9e81764c88a0e0aad0a/packages/nova-core/src/hooks/useCopyToClipboard.ts#L30)

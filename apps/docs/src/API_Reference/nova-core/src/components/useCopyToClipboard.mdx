...
Defined in: [nova-core/src/hooks/useCopyToClipboard.ts:30](https://github.com/TuwaIO/nova-uikit/blob/72ba4c5175ae1e244544729fc37507abd6b654e7/packages/nova-core/src/hooks/useCopyToClipboard.ts#L30)

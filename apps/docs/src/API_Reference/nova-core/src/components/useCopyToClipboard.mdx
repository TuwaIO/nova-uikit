...
Defined in: [packages/nova-core/src/hooks/useCopyToClipboard.ts:30](https://github.com/TuwaIO/nova-uikit/blob/901cdf5c3481c7b1e802c820d1bb514bf27225a6/packages/nova-core/src/hooks/useCopyToClipboard.ts#L30)

...
Defined in: [packages/nova-core/src/utils/getChainName.ts:23](https://github.com/TuwaIO/nova-uikit/blob/765e7c6b4de0f25eb98b4109443627f144982b83/packages/nova-core/src/utils/getChainName.ts#L23)

...
Defined in: [packages/nova-core/src/utils/getChainName.ts:23](https://github.com/TuwaIO/nova-uikit/blob/e7e60eeb40cddd57861979f48cab6eee9f31d014/packages/nova-core/src/utils/getChainName.ts#L23)

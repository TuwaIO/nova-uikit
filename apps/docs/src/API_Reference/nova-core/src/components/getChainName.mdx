...
Defined in: [packages/nova-core/src/utils/getChainName.ts:62](https://github.com/TuwaIO/nova-uikit/blob/d9cb0592017ba8785db83187dd0a7191551b65f5/packages/nova-core/src/utils/getChainName.ts#L62)

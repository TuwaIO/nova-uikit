...
Defined in: [nova-core/src/utils/deepMerge.ts:30](https://github.com/TuwaIO/nova-uikit/blob/65a1bd7ec122493cea8ccec4d6019d37b9a860f4/packages/nova-core/src/utils/deepMerge.ts#L30)

...
Defined in: [nova-core/src/utils/deepMerge.ts:30](https://github.com/TuwaIO/nova-uikit/blob/a9a3dcd0c2fff2c7055f9e3e89db0574c74d1153/packages/nova-core/src/utils/deepMerge.ts#L30)

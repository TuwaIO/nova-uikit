...
Defined in: [nova-core/src/utils/deepMerge.ts:30](https://github.com/TuwaIO/nova-uikit/blob/ff888bf4a4d6917dfef5a182a703ed36e6cd75a9/packages/nova-core/src/utils/deepMerge.ts#L30)

...
Defined in: [nova-core/src/utils/deepMerge.ts:30](https://github.com/TuwaIO/nova-uikit/blob/a67b545111d0920e81369a66855ababc0551c3bc/packages/nova-core/src/utils/deepMerge.ts#L30)

...
Defined in: [nova-core/src/utils/deepMerge.ts:30](https://github.com/TuwaIO/nova-uikit/blob/64ac30667ed7d561db159acf3483498501f2cd23/packages/nova-core/src/utils/deepMerge.ts#L30)

...
Defined in: [nova-core/src/utils/deepMerge.ts:30](https://github.com/TuwaIO/nova-uikit/blob/9fc4813d313dd3fb61ceb79b1bc1d7e0dd2fd13c/packages/nova-core/src/utils/deepMerge.ts#L30)

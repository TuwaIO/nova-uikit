...
Defined in: [packages/nova-core/src/utils/deepMerge.ts:30](https://github.com/TuwaIO/nova-uikit/blob/6c97c381f0e2c0df922ab158d0d6a629378a1956/packages/nova-core/src/utils/deepMerge.ts#L30)

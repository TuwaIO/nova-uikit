...
Defined in: [packages/nova-core/src/utils/deepMerge.ts:30](https://github.com/TuwaIO/nova-uikit/blob/127b4a81efa2388d80b9a5949013038209bbc8ae/packages/nova-core/src/utils/deepMerge.ts#L30)

...
Defined in: [packages/nova-core/src/utils/deepMerge.ts:30](https://github.com/TuwaIO/nova-uikit/blob/285558c250b53f8782e3c578ff7eb8f7806d57a2/packages/nova-core/src/utils/deepMerge.ts#L30)

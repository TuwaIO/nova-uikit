...
Defined in: [packages/nova-core/src/utils/deepMerge.ts:30](https://github.com/TuwaIO/nova-uikit/blob/9743e7f79987e2dfa03044eb756db5e1c1b1b37b/packages/nova-core/src/utils/deepMerge.ts#L30)

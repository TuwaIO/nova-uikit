...
Defined in: [nova-core/src/utils/deepMerge.ts:30](https://github.com/TuwaIO/nova-uikit/blob/648b8eeb44c31213f76bbaf8b563ff7b761e6af5/packages/nova-core/src/utils/deepMerge.ts#L30)

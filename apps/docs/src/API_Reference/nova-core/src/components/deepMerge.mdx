...
Defined in: [nova-core/src/utils/deepMerge.ts:30](https://github.com/TuwaIO/nova-uikit/blob/0264e04d7bd3af82117c3a9b03d510f8f3381744/packages/nova-core/src/utils/deepMerge.ts#L30)

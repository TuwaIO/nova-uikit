...
Defined in: [packages/nova-core/src/utils/deepMerge.ts:30](https://github.com/TuwaIO/nova-uikit/blob/bd692251dc97f123d2fb354ca79bc6d98c48d8a8/packages/nova-core/src/utils/deepMerge.ts#L30)

...
Defined in: [packages/nova-core/src/utils/deepMerge.ts:30](https://github.com/TuwaIO/nova-uikit/blob/b060bd4b0d9a272d387bcfc5d82eeb09e6211536/packages/nova-core/src/utils/deepMerge.ts#L30)

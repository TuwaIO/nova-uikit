...
Defined in: [packages/nova-core/src/utils/deepMerge.ts:30](https://github.com/TuwaIO/nova-uikit/blob/e4ce53b175c2115006bc90676324e32d34e9cd5b/packages/nova-core/src/utils/deepMerge.ts#L30)

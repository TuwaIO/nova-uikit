...
Defined in: [nova-core/src/utils/deepMerge.ts:30](https://github.com/TuwaIO/nova-uikit/blob/fd695363130fe46e904dd8d459ca0673901ff3c3/packages/nova-core/src/utils/deepMerge.ts#L30)

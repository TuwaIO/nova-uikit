...
Defined in: [packages/nova-core/src/components/SvgToImg.tsx:44](https://github.com/TuwaIO/nova-uikit/blob/0209b4b0b1a2cc3fe69220a5dd8b6f3653c188e9/packages/nova-core/src/components/SvgToImg.tsx#L44)

...
Defined in: [packages/nova-core/src/components/SvgToImg.tsx:44](https://github.com/TuwaIO/nova-uikit/blob/ce6baf77f49298f99507f9e1d0ab688bc5ed60f1/packages/nova-core/src/components/SvgToImg.tsx#L44)

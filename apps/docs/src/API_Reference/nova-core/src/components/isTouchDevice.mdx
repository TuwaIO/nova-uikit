...
Defined in: [nova-core/src/utils/isTouchDevice.ts:19](https://github.com/TuwaIO/nova-uikit/blob/55402618b0b493628fca986bb9728815c83a1e8f/packages/nova-core/src/utils/isTouchDevice.ts#L19)

...
Defined in: [packages/nova-transactions/src/providers/NovaProvider.tsx:37](https://github.com/TuwaIO/nova-uikit/blob/08eba8ae8d3f95b682badea39f500181ab46fa0d/packages/nova-transactions/src/providers/NovaProvider.tsx#L37)

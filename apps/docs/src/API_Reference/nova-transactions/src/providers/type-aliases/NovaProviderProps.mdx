...
Defined in: [packages/nova-transactions/src/providers/NovaProvider.tsx:37](https://github.com/TuwaIO/nova-uikit/blob/a6935ad165181db46094cc50c0501928d06a176c/packages/nova-transactions/src/providers/NovaProvider.tsx#L37)

...
Defined in: [packages/nova-transactions/src/providers/NovaTransactionsErrorContext.tsx:106](https://github.com/TuwaIO/nova-uikit/blob/96dae07fda7b200f2f0bdb59111a304c9a56777c/packages/nova-transactions/src/providers/NovaTransactionsErrorContext.tsx#L106)

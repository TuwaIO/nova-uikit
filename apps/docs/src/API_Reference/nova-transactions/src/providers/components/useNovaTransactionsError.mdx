...
Defined in: [packages/nova-transactions/src/providers/NovaTransactionsErrorContext.tsx:106](https://github.com/TuwaIO/nova-uikit/blob/a9450b812221279a19a67d8f947f98e6ec07f0cf/packages/nova-transactions/src/providers/NovaTransactionsErrorContext.tsx#L106)

...
Defined in: [nova-transactions/src/providers/LabelsProvider.tsx:26](https://github.com/TuwaIO/nova-uikit/blob/0b297c472eee91386614e9a3e496df0839899583/packages/nova-transactions/src/providers/LabelsProvider.tsx#L26)

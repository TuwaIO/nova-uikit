...
Defined in: [nova-transactions/src/providers/LabelsProvider.tsx:26](https://github.com/TuwaIO/nova-uikit/blob/0f098f99a286cd51d21eb8dee167e935819b4f4d/packages/nova-transactions/src/providers/LabelsProvider.tsx#L26)

...
Defined in: [nova-transactions/src/providers/LabelsProvider.tsx:26](https://github.com/TuwaIO/nova-uikit/blob/4b8f114134c9a2055055f3192fbe0a69c2544cc3/packages/nova-transactions/src/providers/LabelsProvider.tsx#L26)

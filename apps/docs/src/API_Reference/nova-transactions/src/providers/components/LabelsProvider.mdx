...
Defined in: [nova-transactions/src/providers/LabelsProvider.tsx:26](https://github.com/TuwaIO/nova-uikit/blob/65a1bd7ec122493cea8ccec4d6019d37b9a860f4/packages/nova-transactions/src/providers/LabelsProvider.tsx#L26)

...
Defined in: [nova-transactions/src/providers/LabelsProvider.tsx:26](https://github.com/TuwaIO/nova-uikit/blob/858912fffa0bf561cb7bacaa58997e31e14a1e2a/packages/nova-transactions/src/providers/LabelsProvider.tsx#L26)

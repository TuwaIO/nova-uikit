...
Defined in: [packages/nova-transactions/src/providers/LabelsProvider.tsx:42](https://github.com/TuwaIO/nova-uikit/blob/a9a594a8665072c3f24170aaf92315d433f995a0/packages/nova-transactions/src/providers/LabelsProvider.tsx#L42)

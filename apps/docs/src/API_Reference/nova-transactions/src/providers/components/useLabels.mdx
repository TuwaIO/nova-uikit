...
Defined in: [nova-transactions/src/providers/LabelsProvider.tsx:42](https://github.com/TuwaIO/nova-uikit/blob/2a0be00fbbc0857c12e6df213bbe8a730f821f58/packages/nova-transactions/src/providers/LabelsProvider.tsx#L42)

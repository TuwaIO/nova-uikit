...
Defined in: [nova-transactions/src/providers/LabelsProvider.tsx:42](https://github.com/TuwaIO/nova-uikit/blob/97a37bea904afcd7900be41cc78c4142fd6ca33d/packages/nova-transactions/src/providers/LabelsProvider.tsx#L42)

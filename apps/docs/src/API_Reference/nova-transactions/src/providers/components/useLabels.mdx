...
Defined in: [nova-transactions/src/providers/LabelsProvider.tsx:42](https://github.com/TuwaIO/nova-uikit/blob/7eb7d9cb80759e610ea3db91bfaf38d4f27731f5/packages/nova-transactions/src/providers/LabelsProvider.tsx#L42)

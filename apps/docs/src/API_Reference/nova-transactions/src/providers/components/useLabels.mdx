...
Defined in: [nova-transactions/src/providers/LabelsProvider.tsx:42](https://github.com/TuwaIO/nova-uikit/blob/c69d70bbcd3d3865c2d9c455fb00166e33b0b316/packages/nova-transactions/src/providers/LabelsProvider.tsx#L42)

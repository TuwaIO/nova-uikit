...
Defined in: [nova-transactions/src/providers/LabelsProvider.tsx:42](https://github.com/TuwaIO/nova-uikit/blob/ff888bf4a4d6917dfef5a182a703ed36e6cd75a9/packages/nova-transactions/src/providers/LabelsProvider.tsx#L42)

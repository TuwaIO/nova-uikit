...
Defined in: [nova-transactions/src/providers/LabelsProvider.tsx:42](https://github.com/TuwaIO/nova-uikit/blob/8ea238a5d5c3ee6c7512dc47db64c0550106ae09/packages/nova-transactions/src/providers/LabelsProvider.tsx#L42)

...
Defined in: [nova-transactions/src/providers/LabelsProvider.tsx:42](https://github.com/TuwaIO/nova-uikit/blob/610f49efc99dd4f061efb6227c207ec349c19fb8/packages/nova-transactions/src/providers/LabelsProvider.tsx#L42)

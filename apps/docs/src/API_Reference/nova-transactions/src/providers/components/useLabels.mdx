...
Defined in: [nova-transactions/src/providers/LabelsProvider.tsx:42](https://github.com/TuwaIO/nova-uikit/blob/ece038bfcc92e1d5da07dbae62f4eccfaef52328/packages/nova-transactions/src/providers/LabelsProvider.tsx#L42)

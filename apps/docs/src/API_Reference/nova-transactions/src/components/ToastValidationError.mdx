...
Defined in: [packages/nova-transactions/src/components/ToastValidationError.tsx:254](https://github.com/TuwaIO/nova-uikit/blob/53e7b18341c662e9829e32ebfad915e1004beda0/packages/nova-transactions/src/components/ToastValidationError.tsx#L254)

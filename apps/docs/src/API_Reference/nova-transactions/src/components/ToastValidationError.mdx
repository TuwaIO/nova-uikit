...
Defined in: [packages/nova-transactions/src/components/ToastValidationError.tsx:254](https://github.com/TuwaIO/nova-uikit/blob/351b6666631cfcaa73d7308ed3f9d93b596e34e3/packages/nova-transactions/src/components/ToastValidationError.tsx#L254)

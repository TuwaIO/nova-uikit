...
Defined in: [packages/nova-transactions/src/components/ToastValidationError.tsx:254](https://github.com/TuwaIO/nova-uikit/blob/18d684123e9647f18533e1d4f8043d41e0d95042/packages/nova-transactions/src/components/ToastValidationError.tsx#L254)

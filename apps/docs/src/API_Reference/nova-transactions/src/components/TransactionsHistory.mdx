...
Defined in: [packages/nova-transactions/src/components/TransactionsHistory.tsx:54](https://github.com/TuwaIO/nova-uikit/blob/a6935ad165181db46094cc50c0501928d06a176c/packages/nova-transactions/src/components/TransactionsHistory.tsx#L54)

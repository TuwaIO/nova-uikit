...
Defined in: [packages/nova-transactions/src/components/StatusAwareText.tsx:50](https://github.com/TuwaIO/nova-uikit/blob/1dc28ffb9d17b45d0a6a6e5d7458e83b79e27bc5/packages/nova-transactions/src/components/StatusAwareText.tsx#L50)

...
Defined in: [nova-transactions/src/components/WalletInfoModal/WalletAvatar.tsx:28](https://github.com/TuwaIO/nova-uikit/blob/611ff3c6f869c1dd85d4005cacb055fdb59be697/packages/nova-transactions/src/components/WalletInfoModal/WalletAvatar.tsx#L28)

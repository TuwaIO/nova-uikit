...
Defined in: [nova-transactions/src/components/WalletInfoModal/WalletAvatar.tsx:34](https://github.com/TuwaIO/nova-uikit/blob/7eb7d9cb80759e610ea3db91bfaf38d4f27731f5/packages/nova-transactions/src/components/WalletInfoModal/WalletAvatar.tsx#L34)

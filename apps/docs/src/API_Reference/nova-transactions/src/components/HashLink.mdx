...
Defined in: [packages/nova-transactions/src/components/HashLink.tsx:22](https://github.com/TuwaIO/nova-uikit/blob/6c97c381f0e2c0df922ab158d0d6a629378a1956/packages/nova-transactions/src/components/HashLink.tsx#L22)

...
Defined in: [packages/nova-transactions/src/components/HashLink.tsx:22](https://github.com/TuwaIO/nova-uikit/blob/72f68be37bc6bdb559392b68d8c6a70e68f6207f/packages/nova-transactions/src/components/HashLink.tsx#L22)

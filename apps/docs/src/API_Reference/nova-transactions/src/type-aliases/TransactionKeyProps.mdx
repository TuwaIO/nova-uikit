...
Defined in: [nova-transactions/src/components/TransactionKey.tsx:19](https://github.com/TuwaIO/nova-uikit/blob/904600bb8d86484a28970e5cf7522e598a2879e6/packages/nova-transactions/src/components/TransactionKey.tsx#L19)

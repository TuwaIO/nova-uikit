...
Defined in: [nova-transactions/src/components/TransactionKey.tsx:20](https://github.com/TuwaIO/nova-uikit/blob/607da4bfc83714934b7ce8c7452512024d634763/packages/nova-transactions/src/components/TransactionKey.tsx#L20)

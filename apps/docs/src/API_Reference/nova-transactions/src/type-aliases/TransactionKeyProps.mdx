...
Defined in: [nova-transactions/src/components/TransactionKey.tsx:19](https://github.com/TuwaIO/nova-uikit/blob/89862cb64736abf401f7f95582d5ca748938f79a/packages/nova-transactions/src/components/TransactionKey.tsx#L19)

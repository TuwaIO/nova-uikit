...
Defined in: [packages/nova-transactions/src/components/TxActionButton.tsx:48](https://github.com/TuwaIO/nova-uikit/blob/4ef94ea7f6eea991148bbe105a00e4fe789a9a10/packages/nova-transactions/src/components/TxActionButton.tsx#L48)

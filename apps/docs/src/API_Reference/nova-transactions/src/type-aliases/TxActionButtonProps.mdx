...
Defined in: [packages/nova-transactions/src/components/TxActionButton.tsx:48](https://github.com/TuwaIO/nova-uikit/blob/ec9f25ddba9623ed0a922e6e36541af5128f314a/packages/nova-transactions/src/components/TxActionButton.tsx#L48)

...
Defined in: [nova-transactions/src/components/TxActionButton.tsx:50](https://github.com/TuwaIO/nova-uikit/blob/2f665947b9a0d37380afaefdca7a12c5dd5af844/packages/nova-transactions/src/components/TxActionButton.tsx#L50)

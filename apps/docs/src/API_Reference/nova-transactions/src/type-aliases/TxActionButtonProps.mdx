...
Defined in: [nova-transactions/src/components/TxActionButton.tsx:50](https://github.com/TuwaIO/nova-uikit/blob/ff888bf4a4d6917dfef5a182a703ed36e6cd75a9/packages/nova-transactions/src/components/TxActionButton.tsx#L50)

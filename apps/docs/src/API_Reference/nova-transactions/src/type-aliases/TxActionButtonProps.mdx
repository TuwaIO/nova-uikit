...
Defined in: [nova-transactions/src/components/TxActionButton.tsx:50](https://github.com/TuwaIO/nova-uikit/blob/72ba4c5175ae1e244544729fc37507abd6b654e7/packages/nova-transactions/src/components/TxActionButton.tsx#L50)

...
> **TxActionButtonProps**\<`TR`, `T`\> = `Omit`\<`ButtonHTMLAttributes`\<`HTMLButtonElement`\>, `"onClick"`\> & `object`

Defined in: [nova-transactions/src/components/TxActionButton.tsx:50](https://github.com/TuwaIO/nova-uikit/blob/78a2a232911a274222f152266bfefc233948d277/packages/nova-transactions/src/components/TxActionButton.tsx#L50)

...
Defined in: [nova-transactions/src/components/TxActionButton.tsx:50](https://github.com/TuwaIO/nova-uikit/blob/87cfc2dd068381a9f9b057c1747513f099faa808/packages/nova-transactions/src/components/TxActionButton.tsx#L50)

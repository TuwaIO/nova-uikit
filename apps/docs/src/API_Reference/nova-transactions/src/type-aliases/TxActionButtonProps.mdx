...
Defined in: [packages/nova-transactions/src/components/TxActionButton.tsx:48](https://github.com/TuwaIO/nova-uikit/blob/122eda6c35fda42cb5ebbd4d22b52ca193d73789/packages/nova-transactions/src/components/TxActionButton.tsx#L48)

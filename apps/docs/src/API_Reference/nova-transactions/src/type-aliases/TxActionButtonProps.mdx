...
Defined in: [nova-transactions/src/components/TxActionButton.tsx:50](https://github.com/TuwaIO/nova-uikit/blob/3eb6b94af58da761ccfe525487ec246f89bbf232/packages/nova-transactions/src/components/TxActionButton.tsx#L50)

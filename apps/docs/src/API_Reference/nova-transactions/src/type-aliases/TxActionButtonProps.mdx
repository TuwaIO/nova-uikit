...
Defined in: [nova-transactions/src/components/TxActionButton.tsx:50](https://github.com/TuwaIO/nova-uikit/blob/ed2e28d6e7d892b508553a9859b307eb832fe4c1/packages/nova-transactions/src/components/TxActionButton.tsx#L50)

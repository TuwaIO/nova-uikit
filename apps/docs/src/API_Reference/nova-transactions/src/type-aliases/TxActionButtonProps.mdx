...
Defined in: [nova-transactions/src/components/TxActionButton.tsx:50](https://github.com/TuwaIO/nova-uikit/blob/64ac30667ed7d561db159acf3483498501f2cd23/packages/nova-transactions/src/components/TxActionButton.tsx#L50)

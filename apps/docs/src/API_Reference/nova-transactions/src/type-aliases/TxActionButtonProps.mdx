...
Defined in: [nova-transactions/src/components/TxActionButton.tsx:50](https://github.com/TuwaIO/nova-uikit/blob/ee242172a59c3138b4bd1eef83d50b843bb6d463/packages/nova-transactions/src/components/TxActionButton.tsx#L50)

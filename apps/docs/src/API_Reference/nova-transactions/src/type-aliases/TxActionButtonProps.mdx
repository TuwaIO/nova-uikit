...
Defined in: [nova-transactions/src/components/TxActionButton.tsx:50](https://github.com/TuwaIO/nova-uikit/blob/c8107c8d622a0eca19718ba131f585bcf38f3bf8/packages/nova-transactions/src/components/TxActionButton.tsx#L50)

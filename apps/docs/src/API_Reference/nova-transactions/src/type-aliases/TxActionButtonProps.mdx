...
Defined in: [nova-transactions/src/components/TxActionButton.tsx:50](https://github.com/TuwaIO/nova-uikit/blob/858912fffa0bf561cb7bacaa58997e31e14a1e2a/packages/nova-transactions/src/components/TxActionButton.tsx#L50)

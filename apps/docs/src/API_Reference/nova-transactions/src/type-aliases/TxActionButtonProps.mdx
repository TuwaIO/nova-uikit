...
Defined in: [packages/nova-transactions/src/components/TxActionButton.tsx:42](https://github.com/TuwaIO/nova-uikit/blob/790b6b56437317cdd5647062ff3b5627255c408a/packages/nova-transactions/src/components/TxActionButton.tsx#L42)

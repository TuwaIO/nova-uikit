...
Defined in: [packages/nova-transactions/src/components/TxActionButton.tsx:48](https://github.com/TuwaIO/nova-uikit/blob/5c63ec96aee9f5be7aff8185ccbdd19f8097c126/packages/nova-transactions/src/components/TxActionButton.tsx#L48)

...
Defined in: [nova-transactions/src/components/TxActionButton.tsx:50](https://github.com/TuwaIO/nova-uikit/blob/010ceeb0e63666a83a5c46be8c5bf904027ed4b4/packages/nova-transactions/src/components/TxActionButton.tsx#L50)

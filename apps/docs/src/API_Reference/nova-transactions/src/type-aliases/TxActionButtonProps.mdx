...
Defined in: [nova-transactions/src/components/TxActionButton.tsx:50](https://github.com/TuwaIO/nova-uikit/blob/25426986a8d53b04017c7a66504f80560134f81d/packages/nova-transactions/src/components/TxActionButton.tsx#L50)

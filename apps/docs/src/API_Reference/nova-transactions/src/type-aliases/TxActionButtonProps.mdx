...
Defined in: [nova-transactions/src/components/TxActionButton.tsx:50](https://github.com/TuwaIO/nova-uikit/blob/4b877e5de18d002fe5c470bf137b01e9db4fd576/packages/nova-transactions/src/components/TxActionButton.tsx#L50)

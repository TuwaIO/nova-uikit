...
Defined in: [nova-transactions/src/components/TxActionButton.tsx:50](https://github.com/TuwaIO/nova-uikit/blob/607da4bfc83714934b7ce8c7452512024d634763/packages/nova-transactions/src/components/TxActionButton.tsx#L50)

  ...
  modals: {
    connectModal: {
      classNames: {
        ...
        header: () => cn('bg-[var(--tuwa-bg-secondary)]', 'border-b border-[var(--tuwa-border-primary)]'),
        ...
        footer: () => cn('bg-[var(--tuwa-bg-secondary)]', 'border-t border-[var(--tuwa-border-primary)]'),
...
export const nova_tx_customization: NovaTransactionsProviderProps<any>['customization'] = {
  toast: {
    classNames: {
      container: cn('rounded-[4px]', 'border border-[var(--tuwa-border-primary)]', 'bg-[var(--tuwa-bg-secondary)]'),
      ...
      hashLink: cn(SHARED_STYLES.fontMono, 'text-[var(--tuwa-text-accent)]', 'hover:underline transition-colors'),
  ...
  trackingTxModal: {
    classNames: {
      ...
      header: cn('bg-[var(--tuwa-bg-secondary)]', 'border-[var(--tuwa-border-primary)]'),
...
function App() {
  return (
    <NovaConnectProvider appChains={chains} customization={nova_connect_customization}>
      <NovaTransactionsProvider customization={nova_tx_customization}>{/* Your app */}</NovaTransactionsProvider>
    </NovaConnectProvider>
  );
}
```

...
export function WalletIcon({ walletName, variant = 'background', className }: WalletIconProps) {
  ...
  return (
    <Suspense fallback={<FallbackIcon animate className={className} />}>
      {/**
       * Impersonated Wallet Icon
       * Source: @bgd-labs/web3-icons (MIT License)
       * https://github.com/bgd-labs/web3-icons
       */}
      {walletName === 'impersonatedwallet' ? (
        <svg className={componentClassName} fill="none" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg">
          <path
            fill="#fff"
            fill-rule="evenodd"
